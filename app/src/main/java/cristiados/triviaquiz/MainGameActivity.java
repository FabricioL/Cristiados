...
public class MainGameActivity extends AppCompatActivity {
    ...
    List<Integer> list_options;
    int qid = 0;
    int timeValue = 10;
    int coinValue = 0;
    static int correct2Won = 5;
    List<String> list_youknow;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        list_options = Arrays.asList(1,2,3,4);
        list_youknow = Arrays.asList("Septiembre es el mes de la Biblia porque el día 30 de septiembre es el día de San Jerónimo",
                ...
                "La Biblia se empezó a escribir en tiempos de Moisés, 1.300 años antes de Cristo y se terminó de escribir, poco antes de morir el último apóstol, San Juan",
                "La Iglesia es \"católica\" en cuanto que es \"universal\", busca anunciar la Buena Nueva y recibir en su seno a todos los seres humanos",
                "Durante toda la historia de la Iglesia ha habido hasta el momento 21 Concilios Ecuménicos, sin contar el de los Apóstoles hacia el año 50 en Jerusalén",
                "Juan Bosco es el fundador de la orden salesiana y educador del siglo XIX.",
                "Teresa de Jesús es la fundadora de la orden de Carmelitas Descalzos, doctora de la Iglesia y cumbre de la mística cristiana del siglo XVI. ",
                "Domingo de Guzmán es el fundador de la orden de los Predicadores a comienzos del siglo XIII. ",
                "Benito de Nursia es el fundador de la orden de los benedictinos y patrón de Europa.",
                "Teresa de Calcuta es la fundadora de las Misioneras de la Caridad en el siglo XX.",
                "El país con mayor cantidad de católicos en el mundo es Brasil.",
    ...
    public void updateQueAndOptions() {
        ...
        buttonA.setText(currentQuestion.getOption(list_options.get(0)));
        buttonB.setText(currentQuestion.getOption(list_options.get(1)));
        buttonC.setText(currentQuestion.getOption(list_options.get(2)));
        buttonD.setText(currentQuestion.getOption(list_options.get(3)));
    ...
    public void buttonA(View view) {
        ...
        if (buttonA.getText().equals(currentQuestion.getAnswer())) {
    ...
    public void buttonB(View view) {
        if (buttonB.getText().equals(currentQuestion.getAnswer())) {
    ...
    public void buttonC(View view) {
        if (buttonC.getText().equals(currentQuestion.getAnswer())) {
    ...
    public void buttonD(View view) {
        if (buttonD.getText().equals(currentQuestion.getAnswer())) {
    ...
    public void correctDialog() {
        ...
        TextView youknowText = (TextView) dialogCorrect.findViewById(R.id.youknow);
        //Setting type faces
        correctText.setTypeface(sb);
        youknowText.setTypeface(sb);
        buttonNext.setTypeface(sb);

        Random random = new Random();
        int randomNumber = random.nextInt(100) ;
        if(randomNumber < 50)
            youknowText.setText(list_youknow.get(random.nextInt(list_youknow.size())));
